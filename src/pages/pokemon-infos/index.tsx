    ...
    return (
        <>
          {pokemonFound ? (
            ...
            <div className='w-full text-center mt-48 flex items-center flex-col text-xl gap-12 '>
                <Header infos='pokemons'/>
                <p className='text-black'>Oups il semblerait que nous ne reconnaissions pas ce pokemon :( </p>
                <button onClick={()=>navigate('/pokemons')} className='tracking-[8px] px-6 py-2 border border-solid border-gray-400 text-2xl text-gray-500 font-semibold'>Retour</button>
            </div>
          )}
        </>
