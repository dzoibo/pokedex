...
function PokemonCard(props: any) {
  ...
  return (
    <Link  to={`/pokemons/${pokemon.id}`}  className={'cursor-pointer text-white group flex justify-between relative p-8 overflow-hidden rounded-3xl h-52 w-80 px-6  mt-6 '+pokemon.species.color.backgroung} >
