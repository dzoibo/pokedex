...
import randomImage from './image/random-image.png';
import './App.scss';
      ...
      <div className='global-container p-8'>
        ...
        <div>
          ...
          <div className='grid sm:grid-cols-2 gap-6 sm:gap-8'>
            ...
            <a className={menuCardStyle+'bg-[#dc6661]'}>
          ...
          <div className={menuCardStyle+ 'bg-gray-500 px-6 sm:px-16 mt-6'}>
            ...
            <div className='block items-center sm:flex-row-reverse justify-between sm:flex'>
              ...
              <h1 className='text-3xl self-start sm:text-5xl font-bold leading-[.05em]'>
                <a src='#' className='-ml-4 cursor-pointer px-4 py-1 flex items-center hover:bg-white/20 cursor rounded-md'>
                  Pidgeotto
                </a>
                <svg className=' ml-0 sm:ml-4 inline-block w-8 h-8 transition-transform cursor-pointer hover:scale-110 hover:-rotate-12' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" class="ml-0 sm:ml-4 inline-block w-8 h-8 transition-transform cursor-pointer hover:scale-110 hover:-rotate-12"><path stroke-linecap="round" stroke-linejoin="round" d="M19.114 5.636a9 9 0 010 12.728M16.463 8.288a5.25 5.25 0 010 7.424M6.75 8.25l4.72-4.72a.75.75 0 011.28.53v15.88a.75.75 0 01-1.28.53l-4.72-4.72H4.51c-.88 0-1.704-.507-1.938-1.354A9.01 9.01 0 012.25 12c0-.83.112-1.633.322-2.396C2.806 8.756 3.63 8.25 4.51 8.25H6.75z"></path></svg>
              </h1>
            </div>
          ...
          <a class="mt-6 block w-full font-semibold text-white rounded px-4 py-2 md:w-fit bg-black" href="https://twitter.com/ivan_dzoibo" target="_blank">© By Dzoibo ivan</a>
        </div> 
      </div>
